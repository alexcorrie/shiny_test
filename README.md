...
# nota bene: after you install the listed packages, to run the app again you only need to run commands 4 and 5, the app will load the libraries from steps 2 and 3 for you.
